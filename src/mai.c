...
int main(int argc, char **argv)
{
	...
	music = al_load_sample("Bob Marley - Dont Worry be happy.mp3"); 
	...
	if (!event_queue) { //регестрация евентов
...
al_draw_scaled_bitmap(bouncer,
0, 20, al_get_bitmap_width(bouncer), al_get_bitmap_width(bouncer),
